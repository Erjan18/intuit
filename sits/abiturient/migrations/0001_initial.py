# Generated by Django 3.1.3 on 2022-03-10 15:27
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'verbose_name_plural': 'Абитуриент',
            },
        ),
        migrations.CreateModel(
            name='Career',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=200)),
                ('abiturient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='abiturient.abiturient', verbose_name='Описание Абитуриент')),
            ],
            options={
                'verbose_name': 'Описание Абитуриент',
                'verbose_name_plural': 'Описание Абитуриент',
            },
        ),
    ]
